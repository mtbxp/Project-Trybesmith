...
export async function validateUserVocation(req: Request, res: Response, next: NextFunction) {
...
export async function validateUserLevel(req: Request, res: Response, next: NextFunction) {
...
export async function validateUserPassword(req: Request, res: Response, next: NextFunction) {
