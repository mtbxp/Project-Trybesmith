...
const productsAmountValidation = async (req: Request, res: Response, next: NextFunction) => {
...
const productsNameValidation = async (req: Request, res: Response, next: NextFunction) => {
  const { name } = req.body;
