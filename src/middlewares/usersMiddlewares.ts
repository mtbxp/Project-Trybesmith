...
const isUsernameValid = async (req: Request, res: Response, next: NextFunction) => {
...
const isVocationValid = async (req: Request, res: Response, next: NextFunction) => {
...
const isLevelValid = async (req: Request, res: Response, next: NextFunction) => {
...
const isPasswordValid = async (req: Request, res: Response, next: NextFunction) => {
