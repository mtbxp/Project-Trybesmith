...
export const usernameValidate = async (req: Request, res: Response, next: NextFunction) => {
...
export const vocationValidate = async (req: Request, res: Response, next: NextFunction) => {
...
export const levelValidate = async (req: Request, res: Response, next: NextFunction) => {
...
export const passwordValidate = async (req: Request, res: Response, next: NextFunction) => {
