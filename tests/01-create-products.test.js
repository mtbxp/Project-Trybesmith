...
describe("1 - Crie um endpoint para o cadastro de produtos", function () {
    ...
    it('Será validado que é possível cadastrar um produto com sucesso', function () { return __awaiter(void 0, void 0, void 0, function () {
        var product, result, selected, products;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    product = {
                    ...
                    return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post("/products").send(product)];
                case 1:
                    result = _a.sent();
