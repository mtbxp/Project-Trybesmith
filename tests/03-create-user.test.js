...
describe('3 - Crie um endpoint para o cadastro de pessoas usuárias', function () {
    ...
    it('Será validado que é possível cadastrar a pessoa usuária com sucesso', function () {
        return __awaiter(this, void 0, void 0, function () {
            var user, result, selected, users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user = {
                        ...
                        return [4 /*yield*/, (0, supertest_1.default)(app_1.default).post('/users').send(user)];
                    case 1:
                        result = _a.sent();
                        expect(result.statusCode).toEqual(201);
                        expect(result.body).toBeDefined();
                        expect(result.body.token).toBeDefined();
                        return [4 /*yield*/, connection_1.default.execute('SELECT * FROM Trybesmith.users')];
                    case 2:
                        selected = (_a.sent())[0];
                        users = selected;
