...
describe("4 - Crie um endpoint para listar todos os pedidos", function () {
    ...
    it('Será validado que é possível listar todos os pedidos com sucesso', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(app_1.default).get("/orders")];
                case 1:
                    result = _a.sent();
