            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, connection_1.default.execute('SELECT id, user_id as "userId" FROM Trybesmith.orders')];
                    case 3:
                        selected = (_a.sent())[0];
                        orders = selected;
                        expect(orders).toEqual(expect.arrayContaining([expect.objectContaining({ userId: loggedUserId, id: 4 })]));
                        return [4 /*yield*/, connection_1.default.execute('SELECT id, name, amount, order_id as "orderId" FROM Trybesmith.products')];
                    case 4:
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        expect(products).toEqual(expect.arrayContaining([
                            expect.objectContaining(__assign(__assign({}, fakeProduct), { id: fakeProductId, orderId: orderId })),
                            expect.objectContaining(__assign(__assign({}, fakeProduct2), { id: fakeProduct2Id, orderId: orderId })),
                        ]));
                        return [2 /*return*/];
                }
            });
